...
;;;###autoload
(defun citar-open-library-files (key-entry)
 "Open library files associated with the KEY-ENTRY.
...
;;;###autoload
(defun citar-attach-library-files (key-entry)
  "Attach library files associated with KEY-ENTRY to outgoing MIME message.
